      ...
      <div className="footer-content bg-black gap-3 px-3 px-lg-5 py-5">
        <div className="f-content d-flex flex-wrap justify-content-space-between">
          <div className="contacts w-20">
            ...
            <div className="opacity-75">
              <div>
                <i className="bi bi-geo-alt fd-color-primary me-2"></i>Lagos,
                Nigeria
              </div>
              <div>
                <i className="bi bi-phone fd-color-primary me-2"></i>+229
                964*****
              </div>
              <div>
          ...
          <div className="help">
            ...
            <div className="opacity-75">
              ...
              <div>
                <a href="#">Fodo Market Terms</a>
              </div>
              <div>
                <a href="#">Author Terms</a>
              </div>
              <div>
                <a href="#">Fodo Licences</a>
              </div>
              <div>
                <a href="#">Contact Us</a>
              </div>
        ...
        <div className="d-flex flex-wrap justify-content-between">
          ...
          <p className="opacity-75">
            ...
            <span className="fw-bold">Erox-Emporium</span>
          </p>
        </div>
      </div>
    </footer>
