...
const AllCategory = () => {
  ...
  const categoryList = [
    { id: 1, name: "T shirt" },
    { id: 2, name: "Customised mouse pad" },
    { id: 3, name: "Game gears" },
  ];
    ...
    >
      ...
      <div className="col-12 col-lg-3 py-3 py-lg-0 d-flex gap-2">
          ...
          <div className="col-12 col-lg-3 py-3 py-lg-0 d-flex gap-2">
            ...
            <div>
              <h6 className="fw-bold">Shop with us</h6>
              <span className="font-light opacity-75">
                Find a range of best online Gaming gears as well as Customised Tshirt.
              </span>
            </div>
          </div>
